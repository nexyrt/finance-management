...
return [
    ...
    'rollback_success' => '发票已回退到草稿',
    'rollback_error' => '回退失败',
    'rollback_only_latest' => '只有当月序号最大的发票才能回退到草稿',
    'draft_no_number' => '— 暂无编号 —',
    'number_assigned_on_send' => '发送时将自动分配编号',
    'number_auto_generated_hint' => '编号自动生成，发送前可修改。',
    'send_invoice_title' => '发送发票',
    'send_invoice_subtitle' => '发送前请确认发票编号',
    'invoice_number_required' => '发票编号不能为空',
    'invoice_number_already_used' => '发票编号已被使用',
