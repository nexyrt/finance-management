...
class Listing extends Component
{
    ...
    public function updatedStatusFilter(): void  { $this->resetPage(); unset($this->stats); }
    public function updatedClientFilter(): void  { $this->resetPage(); unset($this->stats); }
    public function updatedSelectedMonth(): void { $this->resetPage(); unset($this->stats); }
    public function updatedDateRange(): void     { $this->resetPage(); unset($this->stats); }
