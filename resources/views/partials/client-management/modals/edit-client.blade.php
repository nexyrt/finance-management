        ...
        <form wire:submit.prevent="saveClient">
            <div class="space-y-5">
                ...
                <div x-data="{ clientType: @entangle('clientType').live }">
                    ...
                    <div x-show="clientType === 'individual'" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">
                    ...
                    <div x-show="clientType === 'company'" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">
                        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 sm:gap-0 mb-2">
