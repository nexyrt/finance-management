            ...
            <div class="auth-left-panel hidden lg:flex lg:w-[52%] xl:w-[55%] relative flex-col overflow-hidden">
                ...
                <div class="relative z-10 flex flex-col justify-between h-full p-12 xl:p-16">
                    ...
                    <div class="flex items-center gap-3">
                        <div class="relative">
                            {{-- Spinning ring --}}
                            <svg class="auth-logo-ring absolute inset-0 w-12 h-12 opacity-20" viewBox="0 0 48 48" fill="none">
                                <circle cx="24" cy="24" r="22" stroke="url(#ring-grad)" stroke-width="1" stroke-dasharray="8 4" />
                                <defs>
                    ...
                    <div class="space-y-8">
                        <div class="space-y-4">
                            <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-500/10 border border-blue-500/20 backdrop-blur-sm">
                                ...
                                <span class="text-blue-300 text-xs font-medium tracking-wider uppercase">Finance Management</span>
                            </div>
