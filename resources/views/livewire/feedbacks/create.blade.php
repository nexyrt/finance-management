        ...
        <form wire:submit="save" id="create-feedback-form" class="space-y-6">
            ...
            <div class="space-y-3" x-data="clipboardPaste">
                ...
                <div x-show="isPasting" x-transition
                     class="flex items-center gap-2 p-3 bg-primary-50 dark:bg-primary-900/20 rounded-xl border border-secondary-200 dark:border-white/10">
            ...
            {{-- Tips --}}
            <div class="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-secondary-200 dark:border-white/10">
