...
>
    ...
    <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
        ...
        <div class="flex items-center gap-3 shrink-0">
            ...
            <button
                ...
                class="h-10 w-10 flex items-center justify-center rounded-xl border border-zinc-200 dark:border-white/10 bg-white dark:bg-[#1e1e1e] text-dark-400 hover:text-blue-600 dark:hover:text-blue-400 hover:border-blue-300 dark:hover:border-blue-700 transition-all"
            ...
            {{-- Key metrics --}}
            <div class="flex gap-5 bg-white dark:bg-[#1e1e1e] rounded-xl border border-zinc-200 dark:border-white/10 px-5 py-4 shadow-sm">
                ...
                <div class="w-px bg-zinc-100 dark:bg-[#161618]"></div>
                <div class="text-center">
    ...
    <div x-show="showGuide"
         ...
         class="bg-white dark:bg-[#1e1e1e] border border-blue-200 dark:border-blue-900/50 rounded-xl overflow-hidden">
            ...
            <div class="flex items-start gap-3">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                        ...
                        {{-- Contoh Monthly --}}
                        <div class="bg-white dark:bg-[#1e1e1e] border border-amber-200 dark:border-amber-900/50 rounded-lg p-3 space-y-2">
                        ...
                        {{-- Aturan Umum --}}
                        <div class="bg-white dark:bg-[#1e1e1e] border border-blue-200 dark:border-blue-900/50 rounded-lg p-3 space-y-2">
                            <div class="flex items-center gap-2">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center gap-3">
        ...
        {{-- Segmented tab bar --}}
        <div class="inline-flex items-center gap-1 p-1 bg-zinc-100 dark:bg-[#27272a] rounded-xl border border-zinc-200 dark:border-white/10 self-start">
