                ...
                <div class="space-y-1">
                    ...
                    <div class="relative">
                        ...
                        <div x-show="itemSelectOpen[item.id]" x-transition
                            class="absolute z-50 mt-1 w-full bg-white dark:bg-[#1e1e1e] border border-dark-200 dark:border-white/8 rounded-xl shadow-lg overflow-hidden">
                            <div class="p-2 border-b border-dark-100 dark:border-white/8">
                ...
                <div class="space-y-1">
                    ...
                    <div class="relative flex gap-2" @click.away="serviceSelectOpen[item.id] = false">
                        ...
                        <div x-show="serviceSelectOpen[item.id]" x-transition
                            class="absolute z-50 top-full mt-1 left-0 w-full bg-white dark:bg-[#1e1e1e] border border-dark-200 dark:border-white/8 rounded-xl shadow-lg overflow-hidden">
                            <div class="overflow-y-auto max-h-48">
                                <template x-for="svc in filteredItemServices(item.id)" :key="svc.id">
