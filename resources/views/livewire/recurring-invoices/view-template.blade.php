        ...
        <div class="space-y-6">
            ...
            <div
                ...
                <div class="flex justify-between items-start">
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-50">{{ $template->template_name }}
                        </h3>
                        <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">{{ $template->client->name }}</p>
                    ...
                    <div class="text-right">
                        <div class="text-xs text-gray-500 dark:text-gray-400">Total Template</div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-600">
                <div class="p-4 border-b border-gray-200 dark:border-gray-600">
                    <h4 class="font-medium text-gray-900 dark:text-gray-50">Template Items</h4>
                </div>
                    ...
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-600">
                            @foreach ($this->templateItems as $item)
                                <tr>
                                    ...
                                    <td class="px-4 py-3 text-center text-sm text-gray-900 dark:text-gray-50">
                                        {{ $item['quantity'] }}
                                    </td>
                                    <td class="px-4 py-3 text-right text-sm text-gray-900 dark:text-gray-50">
                                    ...
                                    <td
                                        class="px-4 py-3 text-right text-sm font-medium text-gray-900 dark:text-gray-50">
                        ...
                        <tfoot class="bg-gray-50 dark:bg-gray-700">
                            <tr>
                                ...
                                <td class="px-4 py-3 text-right text-sm font-medium text-gray-900 dark:text-gray-50">
                            ...
                            <tr>
                                <td colspan="4"
                                    class="px-4 py-3 text-right text-lg font-bold text-gray-900 dark:text-gray-50">
                                    Total:
                                </td>
                                <td
            ...
            @if ($this->nextScheduledInvoices->count() > 0)
                <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-600">
                    <div class="p-4 border-b border-gray-200 dark:border-gray-600">
                        <h4 class="font-medium text-gray-900 dark:text-gray-50">Upcoming Invoices</h4>
                    </div>
                    <div class="p-4">
                        <div class="space-y-3">
        ...
        <x-slot:footer>
            <div class="flex justify-between w-full">
                ...
                <div class="flex gap-2">
                    <x-button wire:click="$dispatch('edit-template', { templateId: {{ $template->id }} })"
                        color="green" size="sm" icon="pencil">
                        Edit Template
                    </x-button>
                    <x-button color="blue" size="sm" icon="document-duplicate">
                        Duplicate
                    </x-button>
                </div>
            </div>
