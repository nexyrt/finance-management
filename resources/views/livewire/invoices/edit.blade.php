<div class="max-w-full mx-auto p-6" x-data="invoiceEditForm()" @click.away="closeAllDropdowns()">
    ...
    <div class="mb-6 space-y-1">
        ...
        <p class="text-dark-600 dark:text-dark-400 text-lg">{{ __('pages.update_invoice_details') }}</p>
    </div>
        ...
        <div class="bg-white dark:bg-dark-800 rounded-xl shadow-sm border border-dark-200 dark:border-dark-600 p-6">
            ...
            <div class="mt-6 pt-6 border-t border-dark-200 dark:border-dark-600" x-data="{ isDragging: false }">
                ...
                @if ($invoice->faktur && !$faktur)
                    <div class="mb-3 p-3 bg-primary-50 dark:bg-primary-900/20 border border-primary-200 dark:border-primary-800 rounded-lg">
