    ...
    <form wire:submit.prevent="save" class="space-y-6">
        ...
        <div class="bg-zinc-50 dark:bg-dark-700 rounded-xl p-4 border border-zinc-200 dark:border-dark-600">
            <div class="flex items-center gap-3 mb-3">
                ...
                <div>
                    <h5 class="text-sm font-semibold text-dark-900 dark:text-dark-50">{{ __('common.preview') }}</h5>
                    <p class="text-xs text-dark-500 dark:text-dark-400">{{ __('common.preview') }}</p>
                </div>
            </div>
                ...
                <div class="flex items-center gap-3 mb-2">
                    ...
                    <div class="min-w-0 flex-1">
                        ...
                        <p class="text-sm text-dark-500 dark:text-dark-400">
                            {{ $bank_name ?: __('common.name') }}
                        </p>
                    </div>
                </div>
                @if($account_number)
                <div class="bg-zinc-50 dark:bg-dark-700 rounded-lg px-3 py-2 mt-2">
                    <p class="text-xs text-dark-500 dark:text-dark-400 mb-1">{{ __('common.name') }}</p>
