<div>
    <x-modal wire title="Lampiran Pembayaran" size="4xl" center>
        @if ($payment && $payment->attachment_path)
            ...
            <div class="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 -m-6 mb-6 p-4">
                        ...
                        <div class="flex justify-center">
                            <div class="relative group">
                                <img src="{{ Storage::url($payment->attachment_path) }}" 
                                     ...
                                     @click="zoomed = true">
                                <div class="absolute inset-0 bg-black/0 group-hover:bg-black/10 rounded-lg transition-colors duration-300 flex items-center justify-center opacity-0 group-hover:opacity-100">
