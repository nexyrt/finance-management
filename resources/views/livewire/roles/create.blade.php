    ...
    <x-modal wire size="2xl" center persistent>
        ...
        <x-slot:title>
            <div class="flex items-center gap-4 my-3">
                ...
                <div>
                    <h3 class="text-xl font-bold text-dark-900 dark:text-dark-50">Add New Role</h3>
                    <p class="text-sm text-dark-600 dark:text-dark-400">Create a new role with custom icon</p>
                </div>
            </div>
        </x-slot:title>

        {{-- Form --}}
        <form id="role-create" wire:submit="save" class="space-y-6">
        ...
        <x-slot:footer>
            <div class="flex flex-col sm:flex-row justify-end gap-3">
                ...
                <x-button type="submit" form="role-create" color="blue" icon="check" loading="save"
