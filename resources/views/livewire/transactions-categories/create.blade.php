    ...
    <x-modal center wire size="md">
        <x-slot:title>
            <div class="flex items-center gap-4 my-3">
                ...
                <div>
                    <h3 class="text-xl font-bold text-dark-900 dark:text-dark-50">{{ __('pages.cat_create_title') }}</h3>
                    <p class="text-sm text-dark-500 dark:text-dark-400">{{ __('pages.cat_page_description') }}</p>
                </div>
            </div>
        </x-slot:title>

        <form id="category-create" wire:submit="save" class="space-y-5">
                    ...
                    <div x-data="{ show: false }" class="relative flex items-center">
                        ...
                        <div x-show="show" x-cloak x-transition:enter="transition ease-out duration-150"
                            ...
                            <div class="bg-dark-800 dark:bg-dark-600 text-dark-50 text-xs rounded-lg px-3 py-2 shadow-lg">
                                <p>Tipe menentukan ke mana kategori ini bisa dipakai — pemasukan, pengeluaran, penyesuaian, atau transfer antar rekening.</p>
                ...
                <div class="grid grid-cols-2 gap-2">
                    ...
                    <button type="button"
                        ...
                        @class([
                            ...
                            // unselected
                            'bg-white dark:bg-dark-800 border-dark-200 dark:border-dark-600 text-dark-500 dark:text-dark-400 hover:border-dark-300 dark:hover:border-dark-500 hover:bg-dark-50 dark:hover:bg-dark-700' => $type !== $opt['value'],
                        ])>
                        ...
                        <div x-data="{ show: false }" class="relative flex items-center">
                            ...
                            <div x-show="show" x-cloak x-transition:enter="transition ease-out duration-150"
                                ...
                                <div class="bg-dark-800 dark:bg-dark-600 text-dark-50 text-xs rounded-lg px-3 py-2 shadow-lg">
                                    ...
                                    <p class="mt-1 text-dark-300">{{ __('pages.cat_parent_hint') }}</p>
                                    <div class="absolute top-full left-1/2 -translate-x-1/2 border-4 border-transparent border-t-dark-800 dark:border-t-dark-600"></div>
                                </div>
                            </div>
                        </div>
            ...
            @elseif($type)
                ...
                <div class="flex items-start gap-3 px-4 py-3 bg-blue-50 dark:bg-blue-900/10 border border-blue-200 dark:border-blue-800/50 rounded-xl">
                    ...
                    <div class="text-xs text-blue-700 dark:text-blue-300 leading-relaxed">
                        <span class="font-semibold">{{ __('pages.cat_no_parent_title') }}.</span>
                        {{ __('pages.cat_no_parent_message', ['type' => ucfirst($type)]) }}
                    </div>
                </div>
            @endif
        ...
        <x-slot:footer>
            <div class="flex flex-col sm:flex-row justify-end gap-3">
                ...
                <x-button type="submit" form="category-create" color="primary" icon="check" loading="save" class="w-full sm:w-auto order-1 sm:order-2">
