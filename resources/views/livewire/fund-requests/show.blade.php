<div>
    @if ($fundRequest)
        @php
            $statusColors = [
                'draft'     => ['badge' => 'secondary', 'bg' => 'bg-zinc-100 dark:bg-[#27272a]',        'text' => 'text-zinc-600 dark:text-zinc-400',         'icon' => 'pencil-square'],
        ...
        <x-modal wire="modal" size="4xl" center>
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    ...
                    <div class="flex items-center gap-3 p-4 bg-zinc-50 dark:bg-[#27272a] rounded-xl border border-zinc-200 dark:border-white/10">
                        <div class="h-10 w-10 bg-zinc-100 dark:bg-[#161618] rounded-lg flex items-center justify-center shrink-0">
                        ...
                        @if ($fundRequest->attachment_path)
                            <div class="col-span-2 lg:col-span-3">
                                ...
                                <a href="{{ Storage::url($fundRequest->attachment_path) }}" target="_blank"
                                   class="inline-flex items-center gap-2 px-3 py-2 rounded-lg border border-zinc-200 dark:border-white/10 bg-white dark:bg-[#1e1e1e] text-sm text-primary-600 dark:text-primary-400 hover:bg-primary-50 dark:hover:bg-primary-900/20 hover:border-primary-300 dark:hover:border-primary-700 transition-colors">
                                ...
                                @foreach ($fundRequest->items as $index => $item)
                                    <tr class="hover:bg-zinc-50 dark:hover:bg-dark-700/50 transition-colors">
                                        ...
                                        <td class="py-3 px-4 hidden sm:table-cell">
                                            <span class="inline-flex items-center px-2 py-0.5 rounded-md bg-zinc-100 dark:bg-[#161618] text-xs text-dark-600 dark:text-dark-300">
                            ...
                            <div class="flex gap-4">
                                <div class="flex flex-col items-center">
                                    ...
                                    @if ($fundRequest->reviewed_by)
                                        <div class="w-0.5 h-8 bg-zinc-200 dark:bg-[#161618] my-1"></div>
                                    @endif
                                </div>
                                <div class="pb-4 pt-1">
                                ...
                                <div class="flex gap-4">
                                    ...
                                    <div class="pb-4 pt-1 flex-1">
                                        ...
                                        @if ($fundRequest->review_notes)
                                            <p class="mt-1.5 text-xs text-dark-700 dark:text-dark-300 italic bg-zinc-50 dark:bg-[#27272a] rounded-lg px-3 py-2 border border-zinc-200 dark:border-white/10">
