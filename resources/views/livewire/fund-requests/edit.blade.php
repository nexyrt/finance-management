<div>
    <x-modal title="{{ __('pages.edit_fund_request') }}" wire="modal" size="4xl" center persistent>
        {{-- HEADER --}}
        <x-slot:title>
            <div class="flex items-center gap-4 my-3">
                <div class="h-12 w-12 bg-yellow-50 dark:bg-yellow-900/20 rounded-xl flex items-center justify-center">
                    <x-icon name="pencil" class="w-6 h-6 text-yellow-600 dark:text-yellow-400" />
                </div>
                <div>
                    <h3 class="text-xl font-bold text-dark-900 dark:text-dark-50">{{ __('pages.edit_fund_request') }}</h3>
                    <p class="text-sm text-dark-600 dark:text-dark-400">{{ __('pages.edit_fund_request_description') }}</p>
                </div>
            </div>
        </x-slot:title>
                    ...
                    <div class="lg:col-span-2">
                        @if ($fundRequest && $fundRequest->attachment_path && !$removeAttachment)
                            ...
                            <div class="flex items-center justify-between p-3 rounded-xl border border-secondary-200 dark:border-dark-600">
                                ...
                                <x-button wire:click="$set('removeAttachment', true)" color="red" size="sm" type="button">
