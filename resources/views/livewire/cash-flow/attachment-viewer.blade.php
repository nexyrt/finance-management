<x-modal wire title="{{ __('common.attachment') }}" size="3xl" center>
    @if ($attachment)
        ...
        {{-- File Info --}}
        <div class="mb-4 p-4 bg-zinc-50 dark:bg-[#27272a] rounded-lg border border-zinc-200 dark:border-white/10">
        ...
        {{-- Preview --}}
        <div class="bg-zinc-100 dark:bg-[#27272a] rounded-lg p-4 min-h-[400px] flex items-center justify-center">
            ...
            @elseif($attachment->isPdfAttachment())
                <iframe src="{{ $attachment->attachment_url }}"
                    class="w-full h-[600px] rounded-lg border-2 border-zinc-300 dark:border-white/10">
                </iframe>
            @else
                <div class="text-center">
                    <div
                        class="h-16 w-16 bg-zinc-200 dark:bg-[#161618] rounded-full flex items-center justify-center mx-auto mb-4">
        ...
        <div class="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div class="p-3 bg-zinc-50 dark:bg-[#27272a] rounded-lg">
