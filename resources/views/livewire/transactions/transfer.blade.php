...
<div>
    <x-modal :title="__('pages.transfer_modal_title')" wire size="3xl" center persistent>
        ...
        <form wire:submit="save" class="space-y-6">
            ...
            <div
                class="bg-linear-to-br from-blue-50 to-indigo-50 dark:from-blue-950/20 dark:to-indigo-950/20 rounded-xl p-6 border border-blue-100 dark:border-blue-900/30">
                ...
                <div class="flex justify-center my-6">
                    <div class="flex items-center gap-3">
                        ...
                        <div class="flex items-center gap-2">
                            <div
                                class="h-px bg-linear-to-r from-red-300 to-green-300 dark:from-red-700 dark:to-green-700 w-16">
                            </div>
                            <div
                            ...
                            <div
                                class="h-px bg-linear-to-r from-green-300 to-green-500 dark:from-green-700 dark:to-green-500 w-16">
                            </div>
                        </div>
            ...
            @if ($from_account_id && $to_account_id && $amount && $description)
                ...
                <div
                    class="bg-linear-to-br from-blue-50 to-indigo-50 dark:from-blue-950/20 dark:to-indigo-950/20 rounded-xl p-6 border border-blue-200 dark:border-blue-800">
