    ...
    <x-modal title="Tambah Pengeluaran" wire="modal" size="xl" center persistent x-on:keydown.enter.window="$wire.save()">
        <x-slot:title>
            <div class="flex items-center gap-4 my-3">
                ...
                <div>
                    <h3 class="text-xl font-bold text-dark-900 dark:text-dark-50">Tambah Pengeluaran</h3>
                    <p class="text-sm text-dark-600 dark:text-dark-400">Catat transaksi uang keluar dari rekening</p>
                </div>
            </div>
        </x-slot:title>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="space-y-4">
                    <div class="border-b border-secondary-200 dark:border-dark-600 pb-4">
                        ...
                        <p class="text-xs text-dark-500 dark:text-dark-400">Informasi utama pengeluaran</p>
                    </div>
                ...
                <div class="space-y-4">
                    ...
                    <x-input wire:model="description" label="Deskripsi *" placeholder="Contoh: Pembayaran listrik kantor..." />
