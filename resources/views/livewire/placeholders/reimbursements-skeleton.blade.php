...
<div class="space-y-6 animate-pulse">
    ...
    <div class="flex items-center gap-3">
        <div class="h-8 bg-gray-200 dark:bg-dark-700 rounded-lg w-64"></div>
        <div class="h-5 bg-gray-200 dark:bg-dark-700 rounded-full w-20"></div>
    ...
    <div class="bg-white dark:bg-dark-800 border border-gray-200 dark:border-dark-600 rounded-xl overflow-hidden">
        ...
        <div class="px-4 py-3 border-b border-gray-100 dark:border-dark-700 flex items-center justify-between gap-4">
            ...
            <div class="h-8 bg-gray-200 dark:bg-dark-700 rounded-lg w-48"></div>
        </div>
        ...
        <div class="border-b border-gray-200 dark:border-dark-600 px-4 py-3 flex gap-4">
            ...
            @foreach ([22, 15, 12, 12, 10, 10, 10, 9] as $w)
                <div class="h-3 bg-gray-200 dark:bg-dark-700 rounded" style="width: {{ $w }}%"></div>
            @endforeach
        </div>
