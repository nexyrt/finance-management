...
/**
* @see \App\Http\Controllers\TransactionCategoryController::updatePlGroup
 * @see app/Http/Controllers/TransactionCategoryController.php:107
 * @route '/transaction-categories/{transactionCategory}/pl-group'
 */
export const updatePlGroup = (args: { transactionCategory: number | { id: number } } | [transactionCategory: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: updatePlGroup.url(args, options),
    method: 'patch',
})

updatePlGroup.definition = {
    methods: ["patch"],
 ...
 * @route '/transaction-categories/{transactionCategory}/pl-group'
 */
updatePlGroup.url = (args: { transactionCategory: number | { id: number } } | [transactionCategory: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { transactionCategory: args }
    }
    ...
    return updatePlGroup.definition.url
            .replace('{transactionCategory}', parsedArgs.transactionCategory.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
 ...
 * @route '/transaction-categories/{transactionCategory}/pl-group'
 */
updatePlGroup.patch = (args: { transactionCategory: number | { id: number } } | [transactionCategory: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: updatePlGroup.url(args, options),
    method: 'patch',
})
...
const TransactionCategoryController = { index, store, update, updatePlGroup, destroy }
