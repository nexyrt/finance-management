 ...
 * @see app/Http/Controllers/Admin/UserController.php:105
...
/**
* @see \App\Http\Controllers\Admin\UserController::bulkDestroy
...
const UserController = { index, store, update, destroy, bulkDestroy }
